...
const translations = {
    pt: {
        ...
        skills_section: {
            title: 'Habilidades',
            html: {
                description: 'HTML5 é a versão mais recente da linguagem de marcação HTML, fundamental para a criação de conteúdo na web. Suas inovações incluem suporte nativo para áudio e vídeo, novos elementos semânticos e APIs para aplicações web interativas, tornando-o a base para páginas modernas e responsivas.',
                items: [
                    'SEO e boas práticas',
                    'HTML5 Semântico',
                    'Acessibilidade Web',
            ...
            css: {
                description: 'CSS3 é a linguagem de estilização que traz vida ao HTML. Com recursos avançados de layout, animações e responsividade, permite criar interfaces modernas e atraentes que se adaptam a diferentes dispositivos e tamanhos de tela.',
                items: [
                    'Flexbox e Grid',
            ...
            js: {
                description: 'JavaScript é a linguagem de programação que permite criar interações dinâmicas na web. Com suporte a programação assíncrona, manipulação do DOM e integração com APIs, torna as aplicações web mais interativas e funcionais.',
                items: [
                    'ES6+',
                    'DOM Manipulation',
                    'Async/Await',
            ...
            java: {
                description: 'Java é uma linguagem versátil e robusta, ideal para desenvolvimento de aplicações empresariais. Com sua forte tipagem e orientação a objetos, permite criar sistemas escaláveis e seguros, além de contar com um vasto ecossistema de frameworks e bibliotecas.',
                items: [
            ...
            git: {
                description: 'Git é um sistema de controle de versão distribuído essencial para o desenvolvimento moderno. Junto com o GitHub, forma uma poderosa plataforma para colaboração em equipe, permitindo o gerenciamento eficiente de código e integração contínua.',
                items: [
            ...
            vscode: {
                description: 'Visual Studio Code é um editor de código moderno e altamente extensível. Com uma grande variedade de extensões e recursos integrados, oferece um ambiente de desenvolvimento produtivo e personalizável para diversas linguagens de programação.',
                items: [
                    'Debugging Avançado',
            ...
            mysql: {
                description: 'MySQL é um dos sistemas de gerenciamento de banco de dados mais populares do mundo. Com sua confiabilidade, desempenho e facilidade de uso, é a escolha ideal para aplicações que necessitam de armazenamento estruturado e consultas eficientes.',
                items: [
                    'Modelagem de Dados',
                    'Queries Complexas',
                    'Stored Procedures',
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        function updateProjectsSection(lang) {
            ...
            projectLinks.forEach(link => {
                ...
                } else if (link.textContent.includes('Ver Código') || link.textContent.includes('View Code')) {
